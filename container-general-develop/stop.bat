...
rem start.bat will recreate it from scratch. This is safe:
rem project files (WSL_MOUNT_SOURCE) and credentials/config (WSL_AWS_HOME,
...
echo.
echo [INFO] Removed. Run start.bat to recreate and start again.
